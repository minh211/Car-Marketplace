...
const FeaturedSection = () => {
    return (
        <div className="bg-[#fff] text-[#232323] py-[80px] px-[64px]">
            <div className="flex justify-between items-end mb-[60px]">
                ...
                <Button className="bg-[#EE1B24] text-white rounded-[5px] w-[180px] h-[40px]">
                    View More
                </Button>
            </div>
            <ScrollContainer className="scroll-container">
                <div className="flex flex-nowrap w-[max-content]">
